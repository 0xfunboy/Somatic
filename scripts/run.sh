...
nohup bash -lc "
  ...
  export SOMA_V10_INTERNAL_RADIO=\${SOMA_V10_INTERNAL_RADIO:-1}
  export SOMA_BROADCAST_INNER_PROMPTS=\${SOMA_BROADCAST_INNER_PROMPTS:-1}
  export SOMA_BROADCAST_INNER_RAW=\${SOMA_BROADCAST_INNER_RAW:-0}
  export SOMA_BROADCAST_INNER_EVIDENCE=\${SOMA_BROADCAST_INNER_EVIDENCE:-1}
  export SOMA_INTERNAL_EVENT_PREVIEW_CHARS=\${SOMA_INTERNAL_EVENT_PREVIEW_CHARS:-900}
  export SOMA_INTERNAL_LEDGER_MAX_LINES=\${SOMA_INTERNAL_LEDGER_MAX_LINES:-5000}
  export SOMA_INTERNAL_LLM_MIN_INTERVAL_SEC=\${SOMA_INTERNAL_LLM_MIN_INTERVAL_SEC:-300}
  export SOMA_INTERNAL_LLM_MAX_PER_HOUR=\${SOMA_INTERNAL_LLM_MAX_PER_HOUR:-6}
  export SOMA_INTERNAL_LLM_SKIP_ON_USER_ACTIVE_SEC=\${SOMA_INTERNAL_LLM_SKIP_ON_USER_ACTIVE_SEC:-45}
  export SOMA_INTERNAL_LLM_SKIP_IN_RESOURCE_RECOVERY=\${SOMA_INTERNAL_LLM_SKIP_IN_RESOURCE_RECOVERY:-1}
  export SOMA_UI_SPEAK_INTERNAL_DEFAULT=\${SOMA_UI_SPEAK_INTERNAL_DEFAULT:-0}
  export SOMA_UI_SPEAK_REPLIES_DEFAULT=\${SOMA_UI_SPEAK_REPLIES_DEFAULT:-0}
  export SOMA_UI_SPEAK_MAX_QUEUE=\${SOMA_UI_SPEAK_MAX_QUEUE:-5}
