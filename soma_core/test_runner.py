...
def _suite_catalog() -> tuple[TestSuite, ...]:
    return (
        ...
        TestSuite(
            ...
            description="The high-signal metabolic / BIOS / introspection validation block required by the current runtime.",
            category="validation",
            ...
            steps=(
                ...
                TestStep("test_bios_loop", "BIOS loop", "python3 scripts/test_bios_loop.py", "Checks BIOS integration and live prompt persistence.", 30.0),
